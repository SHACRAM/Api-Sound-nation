...
import { ModifyGroupe } from "../Components/ModifyGroupe";
        ...
        <div>
            ...
            <div>
                ...
                <div className="hidden sm:flex sm:flex-col sm:fixed sm:left-0 sm:gap-[3em] sm:ml-2 sm:mt-[1em] sm:text-[1rem] border rounded-md">
                    <NavLink to='/InfoPratique' state={true} className='text-white flex justify-center rounded hover:bg-[#858383] w-[11em] pl-1'>Ajouter un groupe</NavLink>
                </div>
                {infoGroupe ?
