        ...
        <div className="flex flex-col items-center p-5">
            ...
            <form className="border border-white p-5 flex flex-col gap-5 mt-5 mb-5 sm:w-[90%] sm:flex-row sm:flex-wrap sm:gap-[4em]" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-2 sm:w-[15em]">
                    ...
                    <select className="rounded bg-white sm:w-[15em] sm:h-7" id="hour" onChange={(e) => setHour(parseInt(e.target.value))} required>
                ...
                <div className="flex flex-col gap-2 sm:w-[15em]">
                    ...
                    <select className="rounded bg-white sm:w-[15em] sm:h-7" id="date" onChange={(e) => setDate(e.target.value)} required>
                ...
                <div className="flex flex-col gap-2 sm:w-[15em]">
                    ...
                    <select className="rounded bg-white sm:w-[15em] sm:h-7" id="scene" onChange={(e) => setScene(e.target.value)} required>
